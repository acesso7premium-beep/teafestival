        ...
        className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background overflow-hidden">
          ...
          className="relative z-10 text-center px-4">
            ...
            className="flex flex-wrap justify-center items-center gap-4">
              ...
              whileTap={{ scale: 0.95 }}
              onClick={handleEnter}
              className="rounded-full bg-secondary text-secondary-foreground hover:bg-secondary/90 text-3xl font-bold px-32 py-12 shadow-lg shadow-secondary/20 transition-colors">
                Entrar no Site
              </motion.button>
            </motion.div>
          </motion.div>
